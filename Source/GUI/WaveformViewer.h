/*
  ==============================================================================
    ...
    WaveformViewer.h
    Created: 29 Apr 2026 10:45:11am
    Author:  Tyler Ryan
...
/**
    ...
    @tags{Audio}
*/
class JUCE_API WaveformViewer  : public Component,
                                           private Timer
{
public:
    /** Creates a visualiser with the given number of channels. */
    WaveformViewer (int initialNumChannels, CompressorPluginAudioProcessor& p);
    ...
    /** Pushes a buffer of channels data.
        ...
        that this WaveformViewer has been told to use.
    */
